...
CREATE TABLE `t_article_image` (
  ...
  CONSTRAINT `fk_t_article_image_t_article` FOREIGN KEY (`articleId`) REFERENCES `t_article` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `t_article_tag` (
  ...
  CONSTRAINT `fk_t_article_has_t_tag_t_article1` FOREIGN KEY (`articleId`) REFERENCES `t_article` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_t_article_has_t_tag_t_tag1` FOREIGN KEY (`tagId`) REFERENCES `t_tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
